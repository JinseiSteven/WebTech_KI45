                ...
                <div class="flex--column nav-bar--items ">
                    ...
                    <div class="section">
                        ...
                        <div class="flex--column nav-bar--items">
                            ...
                            <a href="grades.php">
                                <div class="item" id="grades-page">
                                    <svg width="30" height="30" viewBox="0 0 76 76" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" baseProfile="full" enable-background="new 0 0 76.00 76.00" xml:space="preserve">
                                        <path fill="#114455" fill-opacity="1" stroke-width="0.2" stroke-linejoin="round" d="M 47.4578,53.8333L 39.4751,53.8333L 37.3851,47.3311L
                                        25.4184,47.3311L 23.3502,53.8333L 15.4111,53.8333L 27.2327,21.3222L 35.9047,21.3222L 47.4578,53.8333 Z M 35.433,40.8289L 32.0223,30.0523C 
                                        31.7562,29.2347 31.5723,28.2599 31.4707,27.1278L 31.2893,27.1278C 31.2312,28.0809 31.0401,29.0243 30.716,29.958L 27.2399,40.8289L 35.433,40.8289 
                                        Z M 46.3125,34.8333L 52.25,34.8333L 52.25,28.8958L 58.5833,28.8958L 58.5833,34.8333L 64.5208,34.8333L 64.5208,41.1667L 58.5833,41.1667L 58.5833,47.1042L 
                                        52.25,47.1042L 52.25,41.1667L 46.3125,41.1667L 46.3125,34.8333 Z "/>
                                    </svg>
                                    <span>Grades</span>
                                </div>
                            </a>
                            ...
                            <a href="admin.php">
                                <div class="item" id="admin-page">
                                    <svg width="25" height="25" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <g>
                                        <path d="M16.95 2.58c1.96 1.95 1.96 5.12 0 7.07-1.51 1.51-3.75 1.84-5.59 
                                        1.01l-1.87 3.31-2.99.31L5 18H2l-1-2 7.95-7.69c-.92-1.87-.62-4.18.93-5.73 
                                        1.95-1.96 5.12-1.96 7.07 0zm-2.51 3.79c.74 0 1.33-.6 1.33-1.34 0-.73-.59-1.33-1.33-1.33-.73 
                                        0-1.33.6-1.33 1.33 0 .74.6 1.34 1.33 1.34z"/>
                                        </g>
                                    </svg>
