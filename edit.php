...
<div class="flex--row edit-container">
        ...
        <form action="post-files/edit-post.php" class="flex--column" enctype="multipart/form-data" method="post">
            ...
            <div class="flex--row">
                <div class="flex--column">
                    ...
                    <input type="text" placeholder="e.g. Max" name="name" value="<?php echo $name ?>" required>
                </div>
                <div class="flex--column">
                    <label for="surname">
                        <b>Last name:</b>
                    </label>
                    <input type="text" placeholder="e.g. Rutte" name="surname" value="<?php echo $surname ?>" required>
                </div>
            </div>
            <div class="flex--row">
                <div class="flex--column">
                    ...
                    <input type="text" class="studentid-input" placeholder="e.g. 13977571" name="studentID"
                        value="<?php echo $_SESSION["userStudentID"] ?>" required>
                </div>
                <div class="flex--column">
                    <label for="email">
            ...
            <input type="file" accept="image/png" class="profileimage-input" name="profileimage">
    ...
    <div class="flex--column password-change-box">
        ...
        <form action="post-files/changepwd-post.php" class="flex--column" method="post">
            ...
            <input type="password" placeholder="e.g. Datanose++isTheBest " name="newpwd" required>
            <label for="pwd">
                <b>Repeat new Password:</b>
            </label>
            <input type="password" placeholder="e.g. Datanose++isTheBest " name="newpwdrpt" required>
            <button type="submit" name="submit">Save</button>
        </form>
    </div>
</div>
